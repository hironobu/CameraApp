...
namespace CameraApp
{
    ...
    public class Camera2BasicFragment : Fragment, View.IOnClickListener, FragmentCompat.IOnRequestPermissionsResultCallback, IPreviewSizeCallback
    {
        ...
        public override void OnActivityCreated(Bundle savedInstanceState)
        {
            ...
            mFile = new File(Activity.GetExternalFilesDir(null), $"{Guid.NewGuid()}.jpg");
        ...
        private void SetUpCameraOutputs(int width, int height)
        {
            ...
            try
            {
                for (var i = 0; i < manager.GetCameraIdList().Length; i++)
                {
                    ...
                    _imageReader.SetOnImageAvailableListener(mOnImageAvailableListener, _backgroundHandler);
        ...
        public void OpenCamera(int width, int height)
        {
            ...
            try
            {
                ...
                manager?.OpenCamera(mCameraId, mStateCallback, _backgroundHandler);
            }
            catch (CameraAccessException e)
            {
                e.PrintStackTrace();
        ...
        private void StartBackgroundThread()
        {
            ...
            _backgroundHandler = new Handler(mBackgroundThread.Looper);
        }
        ...
        public void UnlockFocus()
        {
            try
            {
                ...
                _captureSession.Capture(_previewRequestBuilder.Build(), _captureCallback,
                        _backgroundHandler);
                // After this, the camera will go back to the normal state of preview.
                _state = STATE_PREVIEW;
                _captureSession.SetRepeatingRequest(mPreviewRequest, _captureCallback,
                        _backgroundHandler);
            }
            catch (CameraAccessException e)
            {
